package com.smarttrip.app.di

import com.smarttrip.app.BuildConfig
...
object NetworkModule {
    ...
    fun provideAuthInterceptor(tokenDataStore: TokenDataStore): Interceptor {
        return Interceptor { chain ->
            // Uses in-memory cache — zero blocking on the network thread.
            val token = tokenDataStore.cachedToken
